...
class UserRepositoryImplementationTest{
   ...
   UserRepository userRepositoryImplementation;
    ...
    @Test
    void deleteById_UserIsDeleted_CountDecreases(){
        User user = new User();
        userRepositoryImplementation.save(user);
